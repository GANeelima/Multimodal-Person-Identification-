...
def get_args():
    parser = argparse.ArgumentParser(description='Multimodal End-to-End Sparse Model for Person Recognition')
    ...
    # Data
    parser.add_argument('--num-persons', help='Number of persons in data', type=int, required=False, default=10)
